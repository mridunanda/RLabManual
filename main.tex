...
\begingroup
\thispagestyle{empty}
\AddToShipoutPicture*{\put(0,0){\includegraphics[width=8.5in]{pictures/technology-backdrop.jpg}}} % Image background
...
%\vspace*{1cm}
{\Large\textcolor{black}{ Katherine~Bennett, Miguel~de~los~Reyes, Hannah~Gahagan, Raymond~Gao, Sophia~Hurr, Nikhil~Milind, Mridu~Nanda, Christa~Parrish, Ishaan~Rao, Margaux~Winter, Grayson~York}}\par % Author name
\endgroup
